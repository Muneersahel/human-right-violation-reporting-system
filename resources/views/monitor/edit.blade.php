            ...
            <div class="row justify-content-center">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <form  class=" form-horizontal" role="form" method="post" autocomplete="on" action ="{{ route('update-monitor', $user->id) }}" enctype="multipart/form-data" >
                            @csrf
                            @method('put')
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control{{ $errors->has('role') ? ' is-invalid' : '' }}" name="role" id="role"  value="{{ $user->role }}" disabled >
                                            </div>  
                                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <input type="text" class="form-control{{ $errors->has('center_code') ? ' is-invalid' : '' }}" name="center_code" id="center_code"  value="{{ $user->center_code }}" disabled >
                                            </div>  
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            <label for="user_image" class="col-md-4 col-form-label text-md-right">{{ __($user->role.' '.'Passport') }}</label>
                                            <div class="col-md-7">
                            ...
                            <div class="card-footer">
                                <div class="float-left">
                                    <a class="btn btn-info" href="{{ route('monitor/home') }}">&laquo; {{ _('Back') }}</a> 
                                </div>
