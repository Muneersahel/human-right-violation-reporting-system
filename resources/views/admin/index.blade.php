                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <h3 class="card-title col-md-12 col-sm-12">{{ _('STAFF MANAGEMENT') }}
                                    <span class="float-right">
                                        <a class="btn btn-info btn-sm" href="{{ url('admin/create-staff') }}"><i class="fa fa-user-plus"></i> Create Staff</a>
                                    </span>
                                </h3>
                            </div>
                                                ...
                                                @else
                                                    @foreach ($users as $user)
                                                        <tr class="text-justify">
                                                            ...
                                                            <td>{{ ucfirst($user->center_code) }}</td>
                                                            <td>{{ $user->email }}</td>
                                                            ...
                                                            <td>
                                                                <form action="{{ route('destroy-staff', $user->id) }}" method="post" onsubmit="return confirm('Are you sure you want to delete this staff...?') ">
                                                                    ...
                                                                    {{-- <a class="btn btn-info btn-sm" href="{{ url('admin/show-staff', $user->id) }}"><i class="fa fa-ellipsis-h"></i>&nbsp;{{ _('More') }}</a> --}}
                                                                    <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal-lg"><i class="fa fa-ellipsis-h"></i>&nbsp;{{ _('More') }}</button>
                                                                    <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#modal-xl"><i class="fa fa-pencil"></i>&nbsp;{{ _('Edit') }}</button>
                            ...
                            <div class="card-footer">
                                <div class="col-sm-12 col-md-12" role="status" aria-live="polite">
                                    ...
                                    <span class="float-right" id="paginate">{!! $users->links() !!}</span>
                                </div>
                            </div>
                        </div>
                    </div>
