        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ url('admin/home') }}" class="brand-link">
                <img src="{{ asset('images/udom/AdminLogo.png') }}"
                    ...
                    style="opacity: .8">
                <span class="brand-text font-weight-light">{{ _('Admin Profile') }}</span>
            </a>
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="{{ url('admin/edit', Auth::user()->id ) }}" class="d-block">{{ Auth::user()->first_name }}&nbsp;{{ substr(Auth::user()->middle_name, 0,1).'.' }}&nbsp;{{ Auth::user()->last_name }}</a>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <p>{{ _('User Management') }}<i class="fa fa-angle-left right"></i></p>
                            </a>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="{{ url('admin/customer-management') }}" class="nav-link">
                                        <i class="nav-icon fa fa-user"></i>
                                        <p>{{ _('Client Management') }}</p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('admin/application-management') }}" class="nav-link">
