        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="<?php echo e(url('admin/home')); ?>" class="brand-link">
                <img src="<?php echo e(asset('images/udom/AdminLogo.png')); ?>"
                    ...
                    style="opacity: .8">
                <span class="brand-text font-weight-light"><?php echo e(_('Admin Profile')); ?></span>
            </a>

            <!-- Sidebar -->
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image"><?php echo e(public_path()."storage/images/image".auth()->user()->user_image); ?>

                        <img src="/storage/images/image/<?php echo e(Auth::user()->user_image); ?>" class="img-circle elevation-2" alt="Image">
                    </div>
                    <div class="info">
                        <a href="<?php echo e(url('admin/edit', Auth::user()->id )); ?>" class="d-block"><?php echo e(Auth::user()->first_name); ?>&nbsp;<?php echo e(Auth::user()->last_name); ?></a>
                    </div>
                </div>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item has-treeview">
                            <a href="#" class="nav-link">
                                ...
                                <p><?php echo e(_('User Management')); ?><i class="fa fa-angle-left right"></i></p>
                            </a>
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="<?php echo e(url('admin/customer-management')); ?>" class="nav-link">
                                        <i class="nav-icon fa fa-user"></i>
                                        <p><?php echo e(_('Client Management')); ?></p>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(url('admin/application-management')); ?>" class="nav-link">
                                <i class="nav-icon fa fa-book"></i>
                                <p>
                                    <?php echo e(_('Application Management')); ?>
...
<?php echo $__env->make('layouts.user_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Movies\dawasa\resources\views/dawasa/home.blade.php ENDPATH**/ ?>