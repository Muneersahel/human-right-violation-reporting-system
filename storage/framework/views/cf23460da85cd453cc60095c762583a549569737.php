                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-info text-white">
                            <h3 class="card-title"><?php echo e(_( $admin->dawasa_office.' '.'New Appplications')); ?></h3>
                        </div>
                                        ...
                                        <tbody>
                                            <?php if( isset($application) && (count($application) === 1)): ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td>
                                                        <form action="<?php echo e(route('destroy-new', $application[0]->application_id)); ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this application...?') ">
                                                                    
                                                            <a class="btn btn-info btn-sm" href="<?php echo e(url('admin/show-applications',$application[0]->application_id)); ?>"><i class="fa fa-eye"></i>&nbsp;<?php echo e(_('More')); ?></a>
                                            ...
                                            <?php elseif( isset($application) && (count($application) > 1)): ?>
                                                <?php $__currentLoopData = $application; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td>
                                                            <form action="<?php echo e(route('destroy-new', $applicant->application_id)); ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this application...?') ">
                                                                    
                                                                <a class="btn btn-info btn-sm" href="<?php echo e(url('admin/show-applications',$applicant->application_id)); ?>"><i class="fa fa-eye"></i>&nbsp;<?php echo e(_('More')); ?></a>
...
<?php echo $__env->make('dawasa.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\dawasa\resources\views/management/new.blade.php ENDPATH**/ ?>