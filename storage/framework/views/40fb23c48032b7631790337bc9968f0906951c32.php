                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        <div class="text-center">
                            ...
                            <img src="<?php echo e(asset('images/human/lhrc_logo.jpg')); ?>" class="d-block mx-auto img-responsive" alt="lhrc-logo" title="lhrc-logo" width="90px" height="90px"/>
                            ...
                            <h4 class="text-center" style="text-decoration: underline; text-decoration-color:lightslategray; text-underline-offset: 2px;" > 
                              <?php echo e(_('APPLICATION AND AGREEMENT FOR MEMBERSHIP')); ?>
                      ...
                      <div class="row">
                        <div class="col-md-6">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="col-md-7">
                                <input type="email" class="form-control<?php echo e($errors->has('email') ? ' is-invalid' : ''); ?>" name="email" id="email" value="<?php echo e(old('email')); ?>" required>
...
<?php echo $__env->make('layouts.errors', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\human\resources\views/customer/create.blade.php ENDPATH**/ ?>