              ...
              <div class="card">
                ...
                <div class="card-body">
                    <div class="col-lg-12 margin-tb">
                        ...
                        <div class="mt-2 mb-2">
                            <img src="<?php echo e(asset('images/dawasa/dawasa_logo.png')); ?>" class="d-block mx-auto img-responsive" alt="Dawasa-logo" title="Dawasa-logo" width="115px" height="100px"/>
                        </div>
                        ...
                        <div class="col-md-6">
                          <div class="form-group row">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-md-7">
                                  <input type="text" class="form-control<?php echo e($errors->has('block_no') ? ' is-invalid' : ''); ?>" placeholder="eg.361" name="block_no" id="block_no" value="<?php echo e(old('block_no')); ?>" required >
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Petro Richard\Desktop\dawasa\resources\views/customer/create.blade.php ENDPATH**/ ?>