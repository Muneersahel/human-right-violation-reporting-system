                                        ...
                                        <tbody>
                                            <?php if( isset($application) && (count($application) === 1)): ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td class="h6 text-right"><?php echo e(number_format($application[0]->service_line_cost, 2, '.', ',')); ?></td>
                                            ...
                                            <?php elseif( isset($application) && (count($application) > 1)): ?>
                                                <?php $__currentLoopData = $application; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td class="h6 text-right"><?php echo e(number_format($applicant->service_line_cost, 2, '.', ',')); ?></td>
                                                        <td class="text-right">0.00</td>
                                            ...
                                            <?php else: ?>
                                                <tr>
                                                    <td class="btn-default" colspan="10"><h3 class="text-center text-muted">No Application records found: Please apply first to see the progress<h3></td>
                                                </tr>
                                            <?php endif; ?>
                                        </tbody>
                                    </table>
...
<?php echo $__env->make('customer.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\dawasa\resources\views/application/show.blade.php ENDPATH**/ ?>