                        ...
                        <div class="card-body">
                            <div class="col-lg-12 margin-tb">
                                <div class="text-center">
                                    ...
                                    <h4 class="text-center" style="text-decoration: underline; text-decoration-color:lightslategray; text-underline-offset: 2px;" > <?php echo e(_('LHRC RIGHT VIOLANCE VICTIM REPORING FORM')); ?></h4>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <select class="form-control<?php echo e($errors->has('district') ? ' is-invalid' : ''); ?>" name="district" id="district" aria-valuetext="<?php echo e(old('district')); ?>" required >
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <select class="form-control<?php echo e($errors->has('nearest_center') ? ' is-invalid' : ''); ?>" name="nearest_center" id="nearest_center" aria-valuetext="<?php echo e(old('nearest_center')); ?>" required >
                                                        <option value="" selected><?php echo e(_('Choose nearby lhrc center')); ?></option>
...
<?php echo $__env->make('customer.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\human\resources\views/incident/create.blade.php ENDPATH**/ ?>