...
<head>
    ...
    <title><?php echo e(('Human Right')); ?></title>
    ...
    <script src="<?php echo e(asset('js/customer_js/bootstrap.bundle.min.js')); ?>"></script>
    ...
    <body class="hold-transition sidebar-mini" style="background-image: url('images/dawasa/dawasa_log.png');" >
        ...
        <nav class="main-header navbar navbar-expand bg-white navbar-light">
            <img src="<?php echo e(url ('images/human/lhrc_logo-2.png')); ?>" class="img-responsive">
...
<?php /**PATH E:\Projects\human\resources\views/layouts/app2.blade.php ENDPATH**/ ?>