                                                            ...
                                                            <td>
                                                                <form action="<?php echo e(route('destroy-sms', $message->id)); ?>"  method="post" onsubmit="return confirm('Are you sure you want to delete this message...?') ">
                                                                    <div class="justify-content-between">
                                                                        ...
                                                                        <a class="btn btn-success btn-sm" href="<?php echo e(route('edit-sms', $message->id)); ?>"><i class="fa fa-pencil"></i>&nbsp;<?php echo e(_('Assign')); ?></a>
...
<?php echo $__env->make('admin.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\human\resources\views/sms/index.blade.php ENDPATH**/ ?>