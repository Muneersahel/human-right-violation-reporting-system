                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <h3 class="card-title"><?php echo e(_('STAFF MANAGEMENT')); ?>
                                                        ...
                                                        <tr class="text-justify">
                                                            ...
                                                            <td>
                                                                <form action="<?php echo e(route('destroy-staff', $user->id)); ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this staff...?') ">
                                                                    ...
                                                                    <a class="btn btn-info btn-sm" href="<?php echo e(url('admin/show-staff', $user->id)); ?>"><i class="fa fa-ellipsis-h"></i>&nbsp;<?php echo e(_('More')); ?></a>
...
<?php echo $__env->make('admin.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\human\resources\views/admin/index.blade.php ENDPATH**/ ?>