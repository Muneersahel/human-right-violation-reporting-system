                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-info text-white">
                            <h3 class="card-title"><?php echo e(_('CUSTOMER\'S LINE CONSTRUCTION WORKS')); ?></h3>
                        </div>
...
<?php echo $__env->make('construct.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\dawasa\resources\views/construct/create.blade.php ENDPATH**/ ?>