                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <h3 class="card-title"><?php echo e(($user->dawasa_office)); ?> Customer Management
                            ...
                            <div class="card-body">
                                <div class="col-lg-12 margin-tb">
                                    <div class="pull-left">
                                        <h2>List of <?php echo e($user->dawasa_office); ?> Customer</h2>
                                    </div>
                                                ...
                                                <?php else: ?>
                                                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <tr class="text-justify">
                                                            <td><?php echo e(++$i); ?></td>
                                                            <td><?php echo e(ucfirst($customer->first_name)); ?>&nbsp;<?php echo e(ucfirst($user->middle_name)); ?>&nbsp;<?php echo e(ucfirst($user->last_name)); ?></td>
                                                            ...
                                                            <td>
                                                                <form action="<?php echo e(route('destroy-staff', $customer->id)); ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this staff...?') ">
                                                                    ...
                                                                    <a class="btn btn-primary btn-sm" href="<?php echo e(url('admin/edit-staff', $customer->id)); ?>"><i class="fa fa-pencil"></i>&nbsp;<?php echo e(_('Edit')); ?></a>
