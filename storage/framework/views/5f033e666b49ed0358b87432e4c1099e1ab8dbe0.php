                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-info text-white">
                            <h3 class="card-title push-right-7"><?php echo e(_('PAYMENT CONFIRMATION')); ?></h3>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="col-lg-12 margin-tb">
                                ...
                                <div class="mt-2 mb-2">
                                    <img src="<?php echo e(asset('images/dawasa/dawasa_logo.png')); ?>" class="img-responsive d-block mx-auto" alt="Dawasa-logo" title="Dawasa-logo" width="110px" height="80px"/>
                                </div>
                                ...
                                <div class="lead">
                                    <h4 class="text-center" style="text-decoration: underline; text-decoration-color:lightslategray; text-underline-offset: 2px;" > 
                                        <?php echo e('CUSTOMER PAYMENT CONFIRMATION FOR'.' '.strtoupper($application->service_required).' '.'SERVICES'); ?>

                                    </h4>
                                </div>
                            </div>

                            <form  class=" form-horizontal mx-auto" role="form" method="post" autocomplete="on" action="<?php echo e(route('store-payment')); ?>" enctype="multipart/form-data" style="width: 85%; border: 1px solid lightslategray">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row">
                                                <label for="amount" class="col-md-5 col-form-label text-md-right"><?php echo e(_ ('Amount Paid')); ?></label>
                                                <div class="col-md-7">
                                ...
                                <div class="card-footer">
                                    <div class="float-left">
                                        <a class="btn btn-info" href="<?php echo e(route('show-payment')); ?>">&laquo; <?php echo e(_('Back')); ?></a> 
                                    </div>
...
<?php echo $__env->make('customer.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dawasa\resources\views/payment/create1.blade.php ENDPATH**/ ?>