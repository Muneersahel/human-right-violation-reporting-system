                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-7">
                                                <select class="form-control<?php echo e($errors->has('dawasa_office') ? ' is-invalid' : ''); ?>" name="dawasa_office" id="dawasa_office" required >
                                                    ...
                                                    <option class="active" value="<?php echo e($user->dawasa_office); ?>" ><?php echo e(_($user->dawasa_office)); ?></option>
                                                </select>
...
<?php echo $__env->make('dawasa.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dawasa\resources\views/dawasa/create.blade.php ENDPATH**/ ?>