    ...
    <?php $__env->startSection('sidebar'); ?>
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <!-- User Role -->
            <a href="<?php echo e(url('constructor/home')); ?>" class="brand-link">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?php echo e(url('constructor/edit-constructor', Auth::user()->id )); ?>" class="d-block"><?php echo e(Auth::user()->first_name); ?>&nbsp;<?php echo e(Auth::user()->last_name); ?></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?php echo e(url('constructor/home')); ?>" class="nav-link">
                                <i class="nav-icon fa fa-home"></i>
                                <p>
                                    <?php echo e(_('Constructor Home')); ?>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(url('constructor/staff-management')); ?>" class="nav-link">
                                <i class="nav-icon fa fa-users"></i>
                                <p>
                                    <?php echo e(_('Staff Management')); ?>
                        ...
                        <li class="nav-item has-treeview">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="<?php echo e(url('constructor/create-application')); ?>" class="nav-link">
                                        <i class="nav-icon fa fa-folder"></i>
                                        <p>New Applications</p>
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a href="<?php echo e(url('constructor/show-application')); ?>" class="nav-link">
                                        <i class="nav-icon fa fa-folder"></i>
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header text-white bg-info">
                            <h3 class="card-title"><?php echo e(_('Service Line Construction')); ?></h3>
                        </div>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-md-12 text-justify">
                                        <h3 class="mt-0"><?php echo e(_('SERVICE LINE constructor')); ?></h3>
                                        <ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\dawasa\resources\views/construct/home1.blade.php ENDPATH**/ ?>