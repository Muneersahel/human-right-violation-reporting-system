                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header bg-info text-white">
                            <h3 class="card-title"><?php echo e(_( $constructor->dawasa_office.' '.'Customer Appplications')); ?></h3>
                        </div>

                        <div class="card-body">
                            <div class="col-lg-12 margin-tb">
                                <div class="pull-left">
                                    <h4>List of <?php echo e($constructor->dawasa_office); ?> Surveyed Applications</h4>
                                </div>
                                        ...
                                        <tbody>
                                            <?php if( isset($application) && (count($application) === 1)): ?>
                                                <tr role="row" class="odd">
                                                    ...
                                                    <td><?php echo e($application[0]->service_required); ?></td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info btn-sm" href="<?php echo e(url('constructor/application-details',$application[0]->application_id)); ?>">More</a>
                                                        <a class="btn btn-success btn-sm" href="<?php echo e(url('constructor/application-construct',$application[0]->application_id)); ?>">Construct</a>
                                            ...
                                            <?php elseif( isset($application) && (count($application) > 1)): ?>
                                                <?php $__currentLoopData = $application; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $applicant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <tr role="row" class="odd">
                                                        ...
                                                        <td><?php echo e($applicant->service_required); ?></td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-info btn-sm" href="<?php echo e(url('constructor/application-details', $applicant->application_id)); ?>">More</a>
                                                            <a class="btn btn-success btn-sm" href="<?php echo e(url('constructor/application-construct', $applicant->application_id)); ?>">Construct</a>
...
<?php echo $__env->make('construct.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dawasa\resources\views/construct/index.blade.php ENDPATH**/ ?>