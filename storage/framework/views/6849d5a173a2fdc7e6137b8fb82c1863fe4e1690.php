                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-lg-12 margin-tb">
                                ...
                                <div class="lead">
                                    <h4 class="text-center" > <?php echo e(_('MAGOMENI, KINONDONI SOUTH-DAR ES SALAAM AND COAST ZONE')); ?></h4>
                                    <hr style="width: 70%; border: 1px solid lightslategray"/>
                                </div>
                            </div>

                            <form  class=" form-horizontal offset-md-1" role="form" method="post" autocomplete="on" action="<?php echo e(route('store-application')); ?>" enctype="multipart/form-data" style="width: 85%; border: 1px solid lightslategray">
                                <?php echo csrf_field(); ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <select class="form-control<?php echo e($errors->has('application_category') ? ' is-invalid' : ''); ?>" name="application_category" id="application_category" required>
                                                        <option value=""><?php echo e(_ ('Please select..')); ?></option>
...
<?php echo $__env->make('customer.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\dawasa\resources\views/application/create1.blade.php ENDPATH**/ ?>