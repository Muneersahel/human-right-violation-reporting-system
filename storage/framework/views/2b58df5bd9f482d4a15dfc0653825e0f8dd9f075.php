                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <select class="form-control<?php echo e($errors->has('application_category') ? ' is-invalid' : ''); ?>" name="application_category" id="application_category" required>
                                                        ...
                                                        <option value="Line Extension"><?php echo e(_ ('Line extension')); ?></option>
                                            ...
                                            <div class="form-group row" >
                                                ...
                                                <div class="col-md-7">
                                                    <select class="form-control<?php echo e($errors->has('tariff') ? ' is-invalid' : ''); ?>"  name="tariff" id="tariff" required >
                                                        ...
                                                        <option value="D1" id="D1"><?php echo e(_('D1')); ?></option>
                                                        <option value="T1" id="T1"><?php echo e(_('T1')); ?></option>
                                                        <option value="T2" id="T2"><?php echo e(_('T2')); ?></option>
                                                        <option value="T3" id="T3"><?php echo e(_('T3')); ?></option>
                                                        <option value="T4" id="T4"><?php echo e(_('T4')); ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group row " id="account_number" style="display: none">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="text" class="form-control<?php echo e($errors->has('account_number') ? ' is-invalid' : ''); ?>" id="account_number" name="account_number" value="<?php echo e(old('account_number')); ?>" >
                                            ...
                                            <div class="form-group row">
                                                <label for="service_line_cost" class="col-md-5 col-form-label text-md-right"><?php echo e(_('Service line cost')); ?></label>
                                                <div class="col-md-7">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-md-7">
                                                    <textarea rows="5" cols="5" class="form-control<?php echo e($errors->has('survey_remarks') ? ' is-invalid' : ''); ?>" name="survey_remarks" id="survey_remarks" maxlength="150"  placeholder="<?php echo e(_('Remarks (Don\'t exeed 150 chars)')); ?>" required ><?php echo e(old('survey_remarks')); ?></textarea>
...
<?php echo $__env->make('survey.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\dawasa\resources\views/survey/create.blade.php ENDPATH**/ ?>