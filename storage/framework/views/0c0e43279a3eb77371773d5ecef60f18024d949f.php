                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header bg-info text-white">
                                <h3 class="card-title"><?php echo e(($user->dawasa_office)); ?> Staff Management
                            ...
                            <div class="card-body">
                                <div class="col-lg-12 margin-tb">
                                    <div class="pull-left">
                                        <h4>List of <?php echo e($user->dawasa_office); ?> Staff</h4>
                                    </div>
                                                        ...
                                                        <tr class="text-justify">
                                                            ...
                                                            <td>
                                                                <form action="<?php echo e(route('destroy-staff', $user->id)); ?>" method="post" onsubmit="return confirm('Are you sure you want to delete this staff...?') ">
                                                                    ...
                                                                    <a class="btn btn-info btn-sm" href="mailto::<?php echo e($user->email); ?>"><i class="fa fa-envelope-o"></i>&nbsp;<?php echo e(_('Email')); ?></a>
...
<?php echo $__env->make('dawasa.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dawasa\resources\views/dawasa/index.blade.php ENDPATH**/ ?>