                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <div class="float-left">
                                <a class="btn btn-info" href="<?php echo e(route('survey-index')); ?>">&laquo;&nbsp;<?php echo e(_('Prev')); ?></a>
                            </div>

                            <div class="float-right">
                                <a class="btn btn-success" href="<?php echo e(route('survey-create', $application->id)); ?>"><?php echo e(_('Survey')); ?>&nbsp;&raquo;</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('survey.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dawasa\resources\views/survey/show.blade.php ENDPATH**/ ?>