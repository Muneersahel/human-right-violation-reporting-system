        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?php echo e(url('survey/edit', Auth::user()->id )); ?>" class="d-block"><?php echo e(Auth::user()->first_name); ?>&nbsp;<?php echo e(substr(Auth::user()->middle_name, 0,1).'.'); ?>&nbsp;<?php echo e(Auth::user()->last_name); ?></a>
                    </div>
                </div>
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(url('survey/show-payments')); ?>" class="nav-link">
                                <i class="nav-icon fa fa-folder"></i>
                                <p>
                                    <?php echo e(_('Client Application')); ?>

                                    <span class="badge badge-info right">Payment</span>
                                </p>
                            </a>
                        </li>
                    </ul>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Projects\dawasa\resources\views/survey/home.blade.php ENDPATH**/ ?>