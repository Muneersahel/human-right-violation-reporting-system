                                    ...
                                    <tr><th colspan=4 style="background:silver">VICTIM'S INCIDENT DETAILS</th></tr>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="3" style="background:white">
                                                <a class="btn float-left" href="<?php echo e(route('photos', $incident->id)); ?>" style="background:silver"><i class="fa fa-file-image-o" aria-hidden="true"></i> <?php echo e(_($incident->photos)); ?> <i class="fa fa-download" aria-hidden="true"></i></a>
                                                <a class="btn float-right" href="<?php echo e(route('videos', $incident->id)); ?>" style="background:silver" ><i class="fa fa-file-video-o" aria-hidden="true"></i> <?php echo e(($incident->video)); ?> <i class="fa fa-download" aria-hidden="true"></i></a>
                                            </td>
                                        </tr>
                                </table>
                            </div>
...
<?php echo $__env->make('monitor.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\human\resources\views/monitor/show.blade.php ENDPATH**/ ?>