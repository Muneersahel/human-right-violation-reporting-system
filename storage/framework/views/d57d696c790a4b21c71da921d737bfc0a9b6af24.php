                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control select2bs4<?php echo e($errors->has('role') ? ' is-invalid' : ''); ?>" name="role" id="role" style="width: 100%;" required >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input form-control<?php echo e($errors->has('user_image') ? ' is-invalid' : ''); ?>" name="user_image" id="user_image" value="<?php echo e(old('user_image')); ?>" required >
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control select2<?php echo e($errors->has('center_code') ? ' is-invalid' : ''); ?>" name="center_code" id="center_code" required >
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">
                                                <select class="form-control select2<?php echo e($errors->has('district') ? ' is-invalid' : ''); ?>" name="district" id="district" required >
...
<?php echo $__env->make('admin.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/munir/Documents/HR/human/resources/views/admin/create.blade.php ENDPATH**/ ?>