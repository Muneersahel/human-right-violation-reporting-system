                ...
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form  class=" form-horizontal mx-auto" role="form" method="post" autocomplete="on" action="<?php echo e(route('update-sms', $sms->id)); ?>" enctype="multipart/form-data" style="width:65%; border: 1px solid lightslategray">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\human\resources\views/sms/edit.blade.php ENDPATH**/ ?>