                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(url('monitor/show-incidents')); ?>" class="nav-link">
                                ...
                                <p>
                                    <?php echo e(_('Reported Incidents')); ?>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(url('monitor/sms-management')); ?>" class="nav-link">
                                ...
                                <p>
                                    <?php echo e(_('Assigned Incidents')); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Projects\human\resources\views/monitor/home.blade.php ENDPATH**/ ?>