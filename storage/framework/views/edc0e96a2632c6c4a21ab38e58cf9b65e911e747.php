					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header bg-info text-white">
								<h3 class="card-title push-right-7"><?php echo e(_('Voice Recording & Report')); ?></h3>
							</div>
							...
							<div class="card-body">
								<div class="col-lg-12 margin-tb">
									<div class="text-center">
										...
										<img src="<?php echo e(asset('images/app/lhrc_logo.jpg')); ?>" class="img-responsive d-block mx-auto" alt="lhrc-logo" title="lhrc-logo" width="60px" height="60px"/>
										<h4 class="text-center" ><strong><?php echo e(_('Human Right Violations Reporting System')); ?></strong></h4>
										<h4 class="text-center" style="text-decoration: underline; text-decoration-color:lightslategray; text-underline-offset: 2px;" > <?php echo e(_('LHRC RIGHT VIOLANCE VICTIM VOICE RECORDING & REPORT')); ?></h4>
									</div>
								</div>

								<form  class=" form-horizontal mx-auto" method="post" action="<?php echo e(route('store-voice')); ?>" enctype="multipart/form-data" style="width: 60%; border: 1px solid lightslategray">
									<?php echo csrf_field(); ?>
									...
									<div class="col-md-7">
										<?php if(\Session::has('failure')): ?>
											<div class="alert alert-danger">
												<ul>
													<li><?php echo \Session::get('failure'); ?></li>
												</ul>
											</div>
										<?php endif; ?>
									</div>
											...
											<div class="row" id="uploadAudioRecorded" style="display: none;">
												...
												<div class="col-md-10">
													<div class="custom-file">
														<input type="file" class="custom-file-input form-control<?php echo e($errors->has('victim_voice') ? ' is-invalid' : ''); ?>" name="victim_voice" id="upFile" required >
														...
														<?php if($errors->has('victim_voice')): ?>
															<span class="invalid-feedback">
																<strong><?php echo e($errors->first('victim_voice')); ?></strong>
															</span>
														<?php endif; ?>
													</div>
												</div>
								...
								<div class="card-footer">
									...
									<div class="float-right">
										<button type="submit" class="btn btn-success" ><?php echo e(_('Save')); ?> &raquo;</button>
									</div>
								</div>
								</form>
							</div>
	...
	<?php $__env->stopSection(); ?>
<?php echo $__env->make('customer.home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\human\resources\views/voice/create.blade.php ENDPATH**/ ?>