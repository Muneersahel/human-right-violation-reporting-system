        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    ...
                    <div class="info">
                        <a href="<?php echo e(url('constructor/edit', Auth::user()->id )); ?>" class="d-block"><?php echo e(Auth::user()->first_name); ?>&nbsp;<?php echo e(Auth::user()->last_name); ?></a>
                    </div>
                </div>
                        ...
                        <li class="nav-item">
                            <a href="<?php echo e(url('constructor/show-applications')); ?>" class="nav-link">
                                ...
                                <p>
                                    ...
                                    <span class="badge badge-info right">Payed</span>
                                </p>
                            </a>
                        </li>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.user_home', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Project\dawasa\resources\views/construct/home.blade.php ENDPATH**/ ?>